...
const Hero = () => {
    return (
        <section className='h-screen w-screen bg-no-repeat bg-cover bg-fixed overflow-hidden flex flex-col justify-center items-center gap-4' style={{ backgroundImage: `url(${hero})` }}>
